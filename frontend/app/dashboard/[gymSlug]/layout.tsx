...
export default async function DashboardLayout(props: DashboardLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-zinc-950 font-sans text-zinc-100 relative overflow-hidden">
      ...
      {/* Sidebar Panel */}
      <aside className="hidden w-64 border-r border-zinc-950 bg-[#0b0e14] md:flex flex-col z-10">
        {/* Brand Header */}
        <div className="flex h-16 items-center gap-2 border-b border-zinc-950 px-6 bg-[#0b0e14]">
        ...
        {/* Gym Tenant Switcher */}
        <div className="px-4 py-3 border-b border-zinc-950/60 bg-[#07090d]">
          <div className="rounded-xl border border-zinc-950 bg-[#0a0d13] p-3">
        ...
        <div className="border-t border-zinc-950 p-4 bg-[#07090d]">
          ...
          <form action="/api/auth/logout" method="POST">
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-950 bg-zinc-950/30 px-4 py-2 text-xs font-bold text-rose-400 hover:bg-rose-500/10 hover:text-rose-300 transition-all"
            >
      ...
      <div className="flex flex-1 flex-col overflow-hidden z-10">
        {/* Top Header */}
        <header className="flex h-16 items-center justify-between border-b border-zinc-800 bg-zinc-950 px-6 md:px-8">
